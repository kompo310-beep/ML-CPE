...
DATA_PATH = os.path.join(BASE_DIR, "..", "tomato-dataset")
OUTPUT_DIR = os.path.join(BASE_DIR, "outputs")

IMG_SIZE = 100
TEST_SIZE = 0.2
VAL_SIZE = 0.1
MAX_PER_CLASS = 1500   # None = use all images (dataset has 10 tomato classes)
EPOCHS = 50
BATCH_SIZE = 32
...
def main():
    ...
    print("--" * 30)
    print("Neural Network Image Recognition: Tomato Leaf Disease Classification")
    print("--" * 30)
