...
def load_data(data_path, img_size=100, max_per_class=None):
    """Load images from a folder-per-class dataset directory.

    Works for any number of classes: for the Tomato-leaf dataset this
    picks up each disease/health category (e.g. Tomato___healthy,
    Tomato___Late_blight, ...) as one class automatically.
    """
